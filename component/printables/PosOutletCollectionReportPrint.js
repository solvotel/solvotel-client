...
const PosOutletCollectionReportPrint = React.forwardRef((props, ref) => {
...
PosOutletCollectionReportPrint.displayName = 'PosOutletCollectionReportPrint'; // 👈 required

export { PosOutletCollectionReportPrint };
